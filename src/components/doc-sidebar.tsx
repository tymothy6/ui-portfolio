...
export function StyleNavigation () {
    ...
    return (
        <div className="sticky top-8 hidden lg:block h-full w-full pl-16 pr-12 pt-24 pb-16 min-w-[16rem] max-w-[24rem]">
            <p className="text-[15px] text-gray-800 dark:text-gray-300 font-mono pb-4">Style Guide</p>
            <Separator />
            <Accordion type="single" defaultValue="item-1">
                <AccordionItem value="item-1">
                    <AccordionTrigger>Themes</AccordionTrigger>
                        <AccordionContent>
                            ...
                            <Button variant="ghost" asChild className={`${isActive('darkmode') ? 'bg-accent/80 text-accent-foreground dark:text-primary-foreground' : ''}`}>
                                <Link href="/style#darkmode">Dark mode</Link>
                            </Button>
                            <Button variant="ghost" asChild className={`${isActive('variables') ? 'bg-accent/80 text-accent-foreground dark:text-primary-foreground' : ''}`}>
                                <Link href="/style#variables">CSS variables</Link>
                            </Button>
                            <Button variant="ghost" asChild className={`${isActive('semantics') ? 'bg-accent/80 text-accent-foreground dark:text-primary-foreground' : ''}`}>
                                <Link href="/style#semantics">Semantics</Link>
                            </Button>
                            <Button variant="ghost" asChild className={`${isActive('colourspace') ? 'bg-accent/80 text-accent-foreground dark:text-primary-foreground' : ''}`}>
                ...
                <AccordionItem value="item-2">
                    <AccordionTrigger>Components</AccordionTrigger>
                        <AccordionContent>
                        <div className="flex flex-col gap-1 items-start">
                            <Button variant="ghost" asChild className={`${isActive('radix') ? 'bg-accent/80 text-accent-foreground dark:text-primary-foreground' : ''}`}>
                                <Link href="/style#radix">Radix Primitives</Link>
                            </Button>
                            <Button variant="ghost" asChild className={`${isActive('shadcnui') ? 'bg-accent/80 text-accent-foreground dark:text-primary-foreground' : ''}`}>
                                <Link href="/style#shadcnui">shadcn/ui</Link>
                            </Button>
                            <Button variant="ghost" asChild className={`${isActive('figma') ? 'bg-accent/80 text-accent-foreground dark:text-primary-foreground' : ''}`}>
