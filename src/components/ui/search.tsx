  ...
  return (
    ...
    <Button variant="outlinebg60" className="px-3" onClick={() => setOpen(true)}>
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <CommandInput className="text-[1rem]" placeholder="Start typing to search..." />
        ...
        <div id="footer" className="flex flex-row items-center py-4 pl-4 pr-2 justify-between w-full h-[56px] border-t-[1px] bg-background/50 backdrop-blur-lg">
            <div className="w-max h-max flex py-1 px-2 rounded-md bg-primary border border-accent-muted tracking-wide text-[12px] text-accent-foreground/90 cursor-default">Tim's Portfolio</div>
