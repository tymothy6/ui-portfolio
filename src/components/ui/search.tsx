...
export function SearchDialog({
  ...
  return (
    <>
      <Button
        variant="outlinebg60"
        className="px-3 border border-primary-foreground/10"
      ...
      <CommandDialog open={open} onOpenChange={setOpen}>
        ...
        <div className="relative">
            ...
            <CommandGroup heading="Links">
              ...
              >
                ...
                <div className="flex flex-row gap-2">
                  ...
                  <span className="text-muted-foreground hidden">
                    My thoughts on design & development
                  </span>
                  <div className="hidden">
              ...
              {projects.map((project) => (
                ...
                >
                  ...
                  <div className="flex flex-row items-center gap-2">
                    <span className="font-medium w-[240px] truncate">
                      {project.name}
                    </span>
                    <Badge variant="default" className="text-white">
                      <span className="tracking-tight">{project.type}</span>
                    </Badge>
                  </div>
                </CommandItem>
              ))}
              ...
              {posts.map((post) => (
                ...
                >
                  ...
                  <div className="flex flex-col gap-1">
                    ...
                    <span className="text-muted-foreground w-[420px] truncate">
                      {post.summary}
                    </span>
                  </div>
                </CommandItem>
          ...
          <div
            id="footer"
            className="flex flex-row items-center py-4 pl-4 pr-2 justify-between w-full h-[56px] border-t-[1px] bg-popover"
          >
            ...
            <div className="flex flex-row items-center gap-2">
              <div className="text-slate-600 dark:text-slate-300 hover:bg-accent/60 hover:text-accent-foreground dark:hover:text-accent-foreground py-2 pl-3 pr-2 inline-flex items-center justify-center rounded-md text-sm font-medium cursor-default">
                Select
                <kbd className="ml-2 pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border border-gray-200 dark:border-slate-700 bg-muted px-1.5 font-mono text-xs font-medium text-muted-foreground opacity-100">
                  ↑
                </kbd>
                <kbd className="ml-1 pointer-events-none inline-flex h-5 select-none items-center gap-1 rounded border border-gray-200 dark:border-slate-700 bg-muted px-1.5 font-mono text-xs font-medium text-muted-foreground opacity-100">
                  ↓
                </kbd>
              </div>
              <div className="text-slate-600 dark:text-slate-300 hover:bg-accent/60 hover:text-accent-foreground dark:hover:text-accent-foreground py-2 pl-3 pr-2 inline-flex items-center justify-center rounded-md text-sm font-medium cursor-default">
