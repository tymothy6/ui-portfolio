        ...
        <div className="bg-background pt-8 md:pt-16 pb-2 w-full h-full relative overflow-hidden">
            <Popover>
                <PopoverTrigger asChild className="focus-visible:none cursor-pointer">
                    ...
                    className="text-4xl md:text-5xl font-semibold text-foreground/80 top-0 left-0 whitespace-pre inline-block focus-visible:none">{isMarqueeEnabled ? marqueeText : disabledMarqueeText}</h1>
                </PopoverTrigger>
