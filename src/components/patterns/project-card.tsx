...
import { Card, CardContent, CardImageHeader } from "@/components/ui/card";
            ...
            <>
              ...
              <CardContent className="flex flex-row justify-between items-start pt-4 h-full">
                <div className="flex flex-col ${styles.title}">
                  <p
                    className={`text-left text-lg font-semibold text-foreground pr-2 mb-0 ${isHovered ? "underline decoration-primary/90 decoration-4 underline-offset-4" : ""}`}
                  >
                    {data.name}
                  </p>
                  <p className="text-left text-base md:text-lg font-semibold text-gray-800 dark:text-gray-200 pr-2 mb-2">
                    {data.type}
                  </p>
