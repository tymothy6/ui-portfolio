...
export function PageHeader({ children }: { children?: React.ReactNode }) {
  ...
  return (
    ...
    >
      <ProgressBar progress={scrollProgress} className="block md:hidden" />
      <div className="flex justify-between items-center pl-8 pr-4 md:px-8 py-2 md:py-4">
        <Link
          href="/#home"
          className="rounded-lg ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-4"
          onClick={(e) => {
            if (isMenuOpen) {
              e.preventDefault();
            }
            ...
            <Tooltip>
              ...
              <TooltipContent className="p-2 md:block hidden">
                <div className="flex items-center gap-1">
                  <p className="text-sm font-regular">Homepage</p>
