    ...
    <div className="flex flex-col gap-0 max-w-4xl mx-auto">
      ...
      >
        <div className="flex flex-row items-center gap-2 px-4 py-2">
          ...
          <div className="flex px-[6px] py-[2px] rounded-md bg-primary text-primary-foreground text-xs font-mono font-semibold cursor-default">
            {lang}
          </div>
        </div>
        <Button
          ...
          className="text-muted-foreground rounded-none rounded-tr-md border-none font-mono w-max px-4"
        >
          Copy
      ...
      <ScrollArea className="w-full whitespace-nowrap rounded-b-md">
        <div ref={areaRef} className="relative w-full text-sm rounded-b-md">
          <SyntaxHighlighter
            language={lang}
            style={nightOwl}
