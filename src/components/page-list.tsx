...
export const AboutPage: React.FC<HomeProps> = ({ id }) => {
    return (
        <div id={id} className="flex flex-col gap-8 md:grid md:grid-cols-2 px-8 py-8 my-8 mx-4 md:mx-24 lg:ml-48 lg:mr-36 xl:mr-48 scroll-mt-16">
            ...
            <div className="flex flex-col gap-6 lg:gap-8 lg:mr-8">
                ...
                <p className="text-lg md:text-xl font-regular text-foreground leading-relaxed tracking-wide">During my PhD, I developed knowledge translation skills and honed a keen eye for aesthetic design. Now, I work to apply my design skills and data fluency to make complex ideas easier to understand for others.</p>
                ...
                <p className="text-lg md:text-xl font-regular text-foreground leading-relaxed tracking-wide">Feeling inspired? Connect with me to start a project together.</p>
            </div>
        </div>
...
export function ExperiencePage () {
    return(
        <div className="flex flex-col gap-8 md:grid md:grid-cols-2 px-8 py-8 my-8 mx-4 md:mx-24 lg:mx-48">
            ...
            <div className="flex flex-col gap-1 md:gap-2">
                ...
                <p className="text-base md:text-lg font-mono font-regular text-foreground">May 2022 - Present</p>
            </div>
            ...
            <div className="flex flex-col gap-1 md:gap-2">
                ...
                <p className="text-base md:text-lg font-medium text-gray-800 dark:text-gray-200">Montreal, QC</p>
                <p className="text-base md:text-lg font-mono font-regular text-foreground">May 2014 - Jun 2015</p>
    ...
    return (
        <div className="flex flex-col gap-8 md:grid md:grid-cols-2 px-8 py-8 my-8 mx-4 md:mx-24 lg:mx-48">
            ...
            <div className="flex flex-col gap-2">
                ...
                <p className="text-gray-700 dark:text-gray-200 text-base md:text-lg font-medium text-foreground leading-relaxed">Figma, FigJam, ProtoPie, Sketch, Adobe Creative Suite</p>
            </div>
            <Separator className="mt-4 mb-4" />
            <div className="flex flex-col gap-2">
                <h3 className="text-lg font-semibold text-foreground leading-relaxed">User Experience Research</h3>
                <p className="text-gray-700 dark:text-gray-200 text-base md:text-lg font-medium text-foreground leading-relaxed">Maze, Dovetail, Miro, Notion</p>
            </div>
            <Separator className="mt-4 mb-4" />
            <div className="flex flex-col gap-2">
                <h3 className="text-lg font-semibold text-foreground leading-relaxed">Information Design & Data Visualization</h3>
                <p className="text-gray-700 dark:text-gray-200 text-base md:text-lg font-medium text-foreground leading-relaxed">Python, R, SQL, Excel, Tableau</p>
            </div>
            <Separator className="mt-4 mb-4" />
            <div className="flex flex-col gap-2">
                <h3 className="text-lg font-semibold text-foreground leading-relaxed">Web & Mobile Development</h3>
                <p className="text-gray-700 dark:text-gray-200 text-base md:text-lg font-medium text-foreground leading-relaxed">HTML, CSS, JavaScript, React, React Native, Swift, Next.js, Express, MongoDB</p>
            </div>
            </div>
        </div>
    )
...
export const ValuesPage: React.FC<HomeProps> = ({ id }) => {
    return (
        ...
        <div id={id} className="flex-col px-8 py-8 my-8 mx-4 md:mx-24 lg:mx-48 scroll-mt-16">
