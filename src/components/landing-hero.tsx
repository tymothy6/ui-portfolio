...
export const Hero: React.FC<HomeProps> = ({ id }) => {
    return (
        <div 
        id={id}
        className="inset-0 flex flex-col gap-8 pt-24 md:pt-36 lg:pt-48 pb-64 lg:pb-72 my-4 mx-12 md:mx-16 lg:mx-24 max-w-2xl md:max-w-4xl lg:max-w-5xl scroll-mt-48 z-[1]">
