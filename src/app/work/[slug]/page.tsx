    ...
    <main className="bg-gradient-to-br from-background to-slate-50 animate-gradient-xy dark:bg-gradient-to-br dark:from-background dark:to-slate-900 dark:animate-gradient-xy">
      <div>
          ...
          <div className="flex flex-col justify-start">
            ...
            <div className="max-w-lg flex flex-col justify-start gap-4 bg-gray-50 dark:bg-card/70 border border-accent p-4 md:p-8 rounded-lg">
              <div className="flex justify-between items-center">
                ...
                <p className="text-sm md:text-base text-gray-800 dark:text-gray-200 font-mono font-medium tracking-tight">
                  {data.purpose}
                </p>
              </div>
              <Separator />
                  ...
                  <div className="flex justify-between items-center">
                    ...
                    {data.figmaLink && (
                      <div className="flex flex-row items-center gap-2">
                        <span className="text-sm md:text-base text-gray-800 dark:text-gray-200 font-medium font-mono tracking-tight">
                          Figma
                        </span>
                        <Button variant="outline" size="icon" asChild>
                          <Link href={data.figmaLink}>
                            ...
                            <span className="sr-only">
                              Link to {data.name} Figma prototype
                            </span>
                          </Link>
                        </Button>
                      </div>
                      ...
                      <div className="flex flex-row items-center gap-2">
                        ...
                        <Button variant="outline" size="icon" asChild>
                          <Link href={data.githubLink}>
                            ...
                            <span className="sr-only">
                              Link to {data.name} Github repository
                            </span>
                          </Link>
                        </Button>
                      </div>
        ...
        <div className="flex-col space-y-8 pb-24 md:pb-36 lg:pb-48 md:mx-24 lg:mx-48 xl:mx-60">
          <h2 className="text-2xl font-semibold mx-8 mb-4 font-mono">
            Other work
          </h2>
          <div className="mx-0">
            <ProjectCardCarousel
