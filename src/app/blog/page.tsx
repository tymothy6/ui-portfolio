        ...
        <div className="bg-gradient-to-br from-background to-slate-50 animate-gradient-xy dark:bg-gradient-to-br dark:from-background dark:to-slate-800 dark:via-slate-900 dark:animate-gradient-xy">
            ...
            <div className="flex flex-col md:grid md:grid-cols-2 md:space-x-8 pt-36 lg:pt-48 pb-24 md:pb-36 lg:pb-48 mx-8 md:mx-24 lg:mx-48">
                ...
                <div className="flex flex-col justify-start w-full">
                    <p className="text-xl text-foreground font-medium text-gray-800 dark:text-gray-200 leading-relaxed md:tracking-wide mb-8">Welcome to my blog! I&apos;ll be posting about my projects, design ideas, and professional development here. Thoughts? I look forward to our conversation.</p>
                    <div>
            ...
            <div className="mx-8 md:mx-24 lg:mx-36 mb-36">
            <BlogPostGrid />
            </div>
            <PageFooter />
        </div>
